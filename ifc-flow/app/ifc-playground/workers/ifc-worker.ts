type WorkerMessage = {
  type: "init" | "run" | "progress" | "result" | "error" | "debug" | "ready";
  script?: string;
  file?: ArrayBuffer;
  message?: string;
  data?: any;
...
// Initialize Pyodide and load IfcOpenShell
async function initPyodide() {
  try {
    ...
    // @ts-ignore - Pyodide will be loaded from a CDN
...
globals()['results'] = results
    ...
    try {
      // Execute the script from file instead of directly embedding it
